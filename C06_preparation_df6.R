...
table(df_6_camp_event_clean['TYP_EVENT'])
## Plot occurrences for each column ##
barplot(table(df_6_camp_event_clean$TYP_EVENT), main = "Type of feedback event")
...
barplot(table(df_6_camp_event_clean_final$NUM_OPENs), xlab = "Opens per user", ylab = "Number of users", main = "Number of opens")

### CHECK NUM_CLICKs ###

barplot(table(df_6_camp_event_clean_final$NUM_CLICKs), xlab = "Clicks per user", ylab = "Number of users", main = "Number of Clicks")
