...
#Check variables for each column
df_4_cli_privacy_clean$FLAG_PRIVACY_1
df_4_cli_privacy_clean$FLAG_PRIVACY_2
df_4_cli_privacy_clean$FLAG_DIRECT_MKT

#Check occurrences for each column
table(df_4_cli_privacy_clean['FLAG_PRIVACY_1'])
table(df_4_cli_privacy_clean['FLAG_PRIVACY_2'])
table(df_4_cli_privacy_clean['FLAG_DIRECT_MKT'])
